...
suite('masterRootToAccountPrivKey', function() {
    test('returns a xpriv key to a account', function() {
        ...
        return elrnClient.masterRootToAccountPrivKey(rootNode, derivedPathStr , accountNumber)
        .then((address) => {
